...
<head>
    ...
    <title>${manager.company.companyName} | Select Employee</title>
</head>
<body>
<div class="col-md-12">
...
<div class="col-md-12" style="background-color: #f28c38; color: white "><h1 style="text-align:left;font-size:20px;font-family:Verdana ">${manager.company.companyName} | Select Employee</h1></div>
<div>
...
<div class="col-sm-12" style="padding: 0 0 0 0; background-color: #f28c38">
    ...
    <div class="col-sm-3" style="border:1px solid white; padding: 10px"><a href="/secure/superAdmin?sort=taxId&max=4&order=asc" style="color: #f2f2f2; text-decoration: none">Email</a></div>
...
<g:form name="selectEmployee" controller="manager" action="assetToEmployee">
